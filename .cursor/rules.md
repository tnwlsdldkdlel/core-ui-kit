...
- 코드 변경 전에 기존 코드를 충분히 이해하고 분석합니다
- 테스트 코드 작성 시 React Testing Library를 사용합니다
- 접근성(A11y)을 고려하여 ARIA 속성을 적절히 사용합니다
- Storybook을 활용하여 컴포넌트를 문서화합니다
